        ...
        public class CameraScript : MonoBehaviour
        {
            ...
            */
            ...
            void FreeMouseMovementView()
            {
                ...
                {
					float wantedXMouseFreeMovement = ((useJoystickFreeMovementOnly == false) ? ControlFreak2.CF2Input.GetAxis(mouse_Y_axisName) : 0) * Time.deltaTime * mouseSensitvity;
					float wantedYMouseFreeMovement = ((useJoystickFreeMovementOnly == false) ? ControlFreak2.CF2Input.GetAxis(mouse_X_axisName) : 0)* Time.deltaTime * mouseSensitvity;

					if(wantedXMouseFreeMovement == 0)
					{
						wantedXMouseFreeMovement = ControlFreak2.CF2Input.GetAxis(dPad_Y_axisName) * Time.deltaTime * mouseSensitvity;
					}
					if(wantedYMouseFreeMovement == 0)
					{
						wantedYMouseFreeMovement = ControlFreak2.CF2Input.GetAxis(dPad_X_axisName) * Time.deltaTime * mouseSensitvity;
					}
            ...
            public void ScrollMath()
            {
                ...
                {
                    zScrollValue += ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel") * zScrollAmountSensitivity;
                    yScrollValue += ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel") * yScrollAmountSensitivity;
                }
            }
