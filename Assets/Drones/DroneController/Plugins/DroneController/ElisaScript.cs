    ...
    namespace Propelers
    {
        public class ElisaScript : MonoBehaviour
        {
            ...
            */
            ...
            {
                if (ControlFreak2.CF2Input.GetKey(droneMovementScript.forward) ||
                    ControlFreak2.CF2Input.GetKey(droneMovementScript.downward) ||
                    ControlFreak2.CF2Input.GetKey(droneMovementScript.downButton) ||
                    ControlFreak2.CF2Input.GetKey(droneMovementScript.leftward) ||
                    ControlFreak2.CF2Input.GetKey(droneMovementScript.rightward) ||
                    ControlFreak2.CF2Input.GetKey(droneMovementScript.upward) ||
                    ControlFreak2.CF2Input.GetKey(droneMovementScript.downButton) ||
                    ControlFreak2.CF2Input.GetKey(droneMovementScript.downward))
                {
