        ...
        public class DroneMovementScript : MonoBehaviour
        {
            ...
            */
            ...
            void Left_Analog_Y_Translation()
            {
                ...
                {
                    W = (ControlFreak2.CF2Input.GetAxisRaw(left_analog_y) > 0) ? true : false;
                    S = (ControlFreak2.CF2Input.GetAxisRaw(left_analog_y) < 0) ? true : false;
                }
                else if (left_analog_y_movement == JoystickDrivingAxis.sideward)
                {
                    D = (ControlFreak2.CF2Input.GetAxisRaw(left_analog_y) > 0) ? true : false;
                    A = (ControlFreak2.CF2Input.GetAxisRaw(left_analog_y) < 0) ? true : false;
                }
                else if (left_analog_y_movement == JoystickDrivingAxis.upward)
                {
                    if (analogUpDownMovement == true)
                    {
                        I = (ControlFreak2.CF2Input.GetAxisRaw(left_analog_y) > 0) ? true : false;
                        K = (ControlFreak2.CF2Input.GetAxisRaw(left_analog_y) < 0) ? true : false;
                    }
                }
                else if (left_analog_y_movement == JoystickDrivingAxis.rotation)
                {
                    J = (-ControlFreak2.CF2Input.GetAxisRaw(left_analog_y) > 0) ? true : false;
                    L = (-ControlFreak2.CF2Input.GetAxisRaw(left_analog_y) < 0) ? true : false;
                }
            }
            ...
            void Left_Analog_X_Translation()
            {
                ...
                {
                    W = (ControlFreak2.CF2Input.GetAxisRaw(left_analog_x) > 0) ? true : false;
                    S = (ControlFreak2.CF2Input.GetAxisRaw(left_analog_x) < 0) ? true : false;
                }
                else if (left_analog_x_movement == JoystickDrivingAxis.sideward)
                {
                    D = (ControlFreak2.CF2Input.GetAxisRaw(left_analog_x) > 0) ? true : false;
                    A = (ControlFreak2.CF2Input.GetAxisRaw(left_analog_x) < 0) ? true : false;
                }
                else if (left_analog_x_movement == JoystickDrivingAxis.upward)
                {
                    if (analogUpDownMovement == true)
                    {
                        I = (ControlFreak2.CF2Input.GetAxisRaw(left_analog_x) > 0) ? true : false;
                        K = (ControlFreak2.CF2Input.GetAxisRaw(left_analog_x) < 0) ? true : false;
                    }
                }
                else if (left_analog_x_movement == JoystickDrivingAxis.rotation)
                {
                    J = (-ControlFreak2.CF2Input.GetAxisRaw(left_analog_x) > 0) ? true : false;
                    L = (-ControlFreak2.CF2Input.GetAxisRaw(left_analog_x) < 0) ? true : false;
                }
            }
            ...
            void Right_Analog_Y_Translation()
            {
                ...
                {
                    W = (-ControlFreak2.CF2Input.GetAxisRaw(right_analog_y) > 0) ? true : false;
                    S = (-ControlFreak2.CF2Input.GetAxisRaw(right_analog_y) < 0) ? true : false;
                }
                else if (right_analog_y_movement == JoystickDrivingAxis.sideward)
                {
                    D = (ControlFreak2.CF2Input.GetAxisRaw(right_analog_y) > 0) ? true : false;
                    A = (ControlFreak2.CF2Input.GetAxisRaw(right_analog_y) < 0) ? true : false;
                }
                else if (right_analog_y_movement == JoystickDrivingAxis.upward)
                {
                    if (analogUpDownMovement == true)
                    {
                        I = (-ControlFreak2.CF2Input.GetAxisRaw(right_analog_y) > 0) ? true : false;
                        K = (-ControlFreak2.CF2Input.GetAxisRaw(right_analog_y) < 0) ? true : false;
                    }
                }
                else if (right_analog_y_movement == JoystickDrivingAxis.rotation)
                {
                    J = (-ControlFreak2.CF2Input.GetAxisRaw(right_analog_y) > 0) ? true : false;
                    L = (-ControlFreak2.CF2Input.GetAxisRaw(right_analog_y) < 0) ? true : false;
                }
            }
            ...
            void Right_Analog_X_Translation()
            {
                ...
                {
                    W = (-ControlFreak2.CF2Input.GetAxisRaw(right_analog_x) > 0) ? true : false;
                    S = (-ControlFreak2.CF2Input.GetAxisRaw(right_analog_x) < 0) ? true : false;
                }
                else if (right_analog_x_movement == JoystickDrivingAxis.sideward)
                {
                    D = (ControlFreak2.CF2Input.GetAxisRaw(right_analog_x) > 0) ? true : false;
                    A = (ControlFreak2.CF2Input.GetAxisRaw(right_analog_x) < 0) ? true : false;
                }
                else if (right_analog_x_movement == JoystickDrivingAxis.upward)
                {
                    if (analogUpDownMovement == true)
                    {
                        I = (ControlFreak2.CF2Input.GetAxisRaw(right_analog_x) > 0) ? true : false;
                        K = (ControlFreak2.CF2Input.GetAxisRaw(right_analog_x) < 0) ? true : false;
                    }
                }
                else if (right_analog_x_movement == JoystickDrivingAxis.rotation)
                {
                    J = (-ControlFreak2.CF2Input.GetAxisRaw(right_analog_x) > 0) ? true : false;
                    L = (-ControlFreak2.CF2Input.GetAxisRaw(right_analog_x) < 0) ? true : false;
                }
            }
            ...
            void Left_Analog_Y_Movement()
            {
                if (left_analog_y_movement == JoystickDrivingAxis.forward)
                {
                    Vertical_W = ControlFreak2.CF2Input.GetAxis(left_analog_y);
                    Vertical_S = ControlFreak2.CF2Input.GetAxis(left_analog_y);
                }
                else if (left_analog_y_movement == JoystickDrivingAxis.sideward)
                {
                    Horizontal_D = ControlFreak2.CF2Input.GetAxis(left_analog_y);
                    Horizontal_A = ControlFreak2.CF2Input.GetAxis(left_analog_y);
                }
                else if (left_analog_y_movement == JoystickDrivingAxis.upward)
                {
                    if (analogUpDownMovement == true)
                    {
                        Vertical_I = ControlFreak2.CF2Input.GetAxis(left_analog_y);
                        Vertical_K = ControlFreak2.CF2Input.GetAxis(left_analog_y);
                    }
                }
                else if (left_analog_y_movement == JoystickDrivingAxis.rotation)
                {
                    Horizontal_J = ControlFreak2.CF2Input.GetAxis(left_analog_y);
                    Horizontal_L = ControlFreak2.CF2Input.GetAxis(left_analog_y);
                }
            }
            void Left_Analog_X_Movement()
            {
                if (left_analog_x_movement == JoystickDrivingAxis.forward)
                {
                    Vertical_W = ControlFreak2.CF2Input.GetAxis(left_analog_x);
                    Vertical_S = ControlFreak2.CF2Input.GetAxis(left_analog_x);
                }
                else if (left_analog_x_movement == JoystickDrivingAxis.sideward)
                {
                    Horizontal_D = ControlFreak2.CF2Input.GetAxis(left_analog_x);
                    Horizontal_A = ControlFreak2.CF2Input.GetAxis(left_analog_x);
                }
                else if (left_analog_x_movement == JoystickDrivingAxis.upward)
                {
                    if (analogUpDownMovement == true)
                    {
                        Vertical_I = ControlFreak2.CF2Input.GetAxis(left_analog_x);
                        Vertical_K = ControlFreak2.CF2Input.GetAxis(left_analog_x);
                    }
                }
                else if (left_analog_x_movement == JoystickDrivingAxis.rotation)
                {
                    Horizontal_J = ControlFreak2.CF2Input.GetAxis(left_analog_x);
                    Horizontal_L = ControlFreak2.CF2Input.GetAxis(left_analog_x);
                }
            }
            void Right_Analog_Y_Movement()
            {
                if (right_analog_y_movement == JoystickDrivingAxis.forward)
                {
                    Vertical_W = -ControlFreak2.CF2Input.GetAxis(right_analog_y);
                    Vertical_S = -ControlFreak2.CF2Input.GetAxis(right_analog_y);
                }
                else if (right_analog_y_movement == JoystickDrivingAxis.sideward)
                {
                    Horizontal_D = ControlFreak2.CF2Input.GetAxis(right_analog_y);
                    Horizontal_A = ControlFreak2.CF2Input.GetAxis(right_analog_y);
                }
                else if (right_analog_y_movement == JoystickDrivingAxis.upward)
                {
                    if (analogUpDownMovement == true)
                    {
                        Vertical_I = -ControlFreak2.CF2Input.GetAxis(right_analog_y);
                        Vertical_K = -ControlFreak2.CF2Input.GetAxis(right_analog_y);
                    }
                }
                else if (right_analog_y_movement == JoystickDrivingAxis.rotation)
                {
                    Horizontal_J = ControlFreak2.CF2Input.GetAxis(right_analog_y);
                    Horizontal_L = ControlFreak2.CF2Input.GetAxis(right_analog_y);
                }
            }
            void Right_Analog_X_Movement()
            {
                if (right_analog_x_movement == JoystickDrivingAxis.forward)
                {
                    Vertical_W = -ControlFreak2.CF2Input.GetAxis(right_analog_x);
                    Vertical_S = -ControlFreak2.CF2Input.GetAxis(right_analog_x);
                }
                else if (right_analog_x_movement == JoystickDrivingAxis.sideward)
                {
                    Horizontal_D = ControlFreak2.CF2Input.GetAxis(right_analog_x);
                    Horizontal_A = ControlFreak2.CF2Input.GetAxis(right_analog_x);
                }
                else if (right_analog_x_movement == JoystickDrivingAxis.upward)
                {
                    if (analogUpDownMovement == true)
                    {
                        Vertical_I = ControlFreak2.CF2Input.GetAxis(right_analog_x);
                        Vertical_K = ControlFreak2.CF2Input.GetAxis(right_analog_x);
                    }
                }
                else if (right_analog_x_movement == JoystickDrivingAxis.rotation)
                {
                    Horizontal_J = ControlFreak2.CF2Input.GetAxis(right_analog_x);
                    Horizontal_L = ControlFreak2.CF2Input.GetAxis(right_analog_x);
                }
            }
            ...
            {
                for (int i = 0; i < ControlFreak2.CF2Input.touches.Length; i++)
                {
                    myTouchPosition[i] = DrawGUI.Percentages(new Vector2(ControlFreak2.CF2Input.GetTouch(i).position.x, Screen.height - ControlFreak2.CF2Input.GetTouch(i).position.y));
                }
            ...
            {
                velocity = ourDrone.linearVelocity.magnitude;
            }
			...
			public void RotationUpdateLoop_TrickRotation()
            {
                if (mainCamera.pickedMyDrone == true)
                {
                    ...
                    {
                        if ((ControlFreak2.CF2Input.GetKeyDown(barrelRollLeft) || ControlFreak2.CF2Input.GetKeyDown(joystick_barrelRollLeft)) && idle == false)
                        {
                            wantedYRotation -= 100;
                        }
                        if ((ControlFreak2.CF2Input.GetKeyDown(barrelRollRight) || ControlFreak2.CF2Input.GetKeyDown(joystick_barrelRollRight)) && idle == false)
                        {
                            wantedYRotation += 100;
                        }
                    }
            ...
            public void CameraCorrectPickAndTranslatingInputToWSAD()
            {
                ...
                if ((mainCamera.pickedMyDrone == true && mainCamera.ourDrone.transform == transform))
                {
                    ...
                    {
                        W = (ControlFreak2.CF2Input.GetKey(forward)) ? true : false;
                        S = (ControlFreak2.CF2Input.GetKey(backward)) ? true : false;
                        A = (ControlFreak2.CF2Input.GetKey(leftward)) ? true : false;
                        D = (ControlFreak2.CF2Input.GetKey(rightward)) ? true : false;

                        I = (ControlFreak2.CF2Input.GetKey(upward)) ? true : false;
                        J = (ControlFreak2.CF2Input.GetKey(rotateLeftward)) ? true : false;
                        K = (ControlFreak2.CF2Input.GetKey(downward)) ? true : false;
                        L = (ControlFreak2.CF2Input.GetKey(rotateRightward)) ? true : false;
                    }
                    if (mobile_turned_on == false && joystick_turned_on == true)
                    {
                        ...
                        if (analogUpDownMovement == false)
                        {
                            K = (ControlFreak2.CF2Input.GetKey(downButton)) ? true : false;
                            I = (ControlFreak2.CF2Input.GetKey(upButton)) ? true : false;
                        }
            ...
            public void Animations()
            {
                if (animatedGameObject != null)
                {
                    ...
                    if (ControlFreak2.CF2Input.GetKeyDown(swingLeft) || ControlFreak2.CF2Input.GetKeyDown(joystick_swingLeft) && idle == false)
                    {
                        StartCoroutine("Left_Passage");
                    }
                    if (ControlFreak2.CF2Input.GetKeyDown(swingRight) || ControlFreak2.CF2Input.GetKeyDown(joystick_swingRight) && idle == false)
                    {
            ...
            public void ClampingSpeedValues()
            {
                if ((W || S) && (A || D))
                {
                    ourDrone.linearVelocity = Vector3.ClampMagnitude(ourDrone.linearVelocity, Mathf.Lerp(ourDrone.linearVelocity.magnitude, maxForwardSpeed, Time.deltaTime * 5f));
                }
                if ((W || S) && (!A && !D))
                {
                    ourDrone.linearVelocity = Vector3.ClampMagnitude(ourDrone.linearVelocity, Mathf.Lerp(ourDrone.linearVelocity.magnitude, maxForwardSpeed, Time.deltaTime * 5f));
                ...
                if ((!W && !S) && (A || D))
                {
                    ourDrone.linearVelocity = Vector3.ClampMagnitude(ourDrone.linearVelocity, Mathf.Lerp(ourDrone.linearVelocity.magnitude, maxSidewaySpeed, Time.deltaTime * 5f));
                }
                if (!W && !S && !A && !D)
                {
                    ourDrone.linearVelocity = Vector3.SmoothDamp(ourDrone.linearVelocity, Vector3.zero, ref velocityToSmoothDampToZero, slowDownTime);
                }
            }
