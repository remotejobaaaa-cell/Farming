...
public class bl_OrbitTouch : MonoBehaviour
{
    ...
    void ControlInput()
    {
        ...
        {
            ControlFreak2.InputRig.Touch t = ControlFreak2.CF2Input.touches[i];
    ...
    public void OnPointerDown(ControlFreak2.InputRig.Touch data)
    {
    ...
    /// </summary>
    /// <param name="data"></param>
    public void OnDrag(ControlFreak2.InputRig.Touch data)
    {
        if (m_CameraOrbit == null)
        {
            Debug.LogWarning("Please assign a camera orbit target");
    ...
    void PinchZoom()
    {
        ...
        if (ControlFreak2.CF2Input.touchCount == 2 && ControlFreak2.CF2Input.GetTouch(0).phase == TouchPhase.Moved && ControlFreak2.CF2Input.GetTouch(1).phase == TouchPhase.Moved)
        {
            // Store both touches.
    ...
    /// </summary>
    /// <param name="data"></param>
    public void OnPointerUp(ControlFreak2.InputRig.Touch data)
    {
        if (m_CameraOrbit == null)
        {
            Debug.LogWarning("Please assign a camera orbit target");
