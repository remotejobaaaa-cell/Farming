...
public class bl_CameraOrbit : bl_CameraBase
{
    ...
    void OnStopRotating()
   {
        ...
        pointerDelta = ControlFreak2.CF2Input.mousePosition - lastMousePosition;
        ...
        get
        {
            switch (RotateInputKey)
            {
                case CameraMouseInputType.All:
                    return (ControlFreak2.CF2Input.GetKey(KeyCode.Mouse0) || ControlFreak2.CF2Input.GetKey(KeyCode.Mouse1) || ControlFreak2.CF2Input.GetKey(KeyCode.Mouse2) || ControlFreak2.CF2Input.GetMouseButton(0));
                case CameraMouseInputType.LeftAndRight:
                    return (ControlFreak2.CF2Input.GetKey(KeyCode.Mouse0) || ControlFreak2.CF2Input.GetKey(KeyCode.Mouse1));
                case CameraMouseInputType.LeftMouse:
                    return (ControlFreak2.CF2Input.GetKey(KeyCode.Mouse0));
                case CameraMouseInputType.RightMouse:
                    return (ControlFreak2.CF2Input.GetKey(KeyCode.Mouse1));
                case CameraMouseInputType.MouseScroll:
                    return (ControlFreak2.CF2Input.GetKey(KeyCode.Mouse2));
                case CameraMouseInputType.MobileTouch:
                    return (ControlFreak2.CF2Input.GetMouseButton(0) || ControlFreak2.CF2Input.GetMouseButton(1));
                default:
                    return (ControlFreak2.CF2Input.GetKey(KeyCode.Mouse0));
            }
        }
    ...
    private bool isInputUpKeyRotate
    {
        get
        {
            ...
            {
                case CameraMouseInputType.All:
                    return (ControlFreak2.CF2Input.GetKeyUp(KeyCode.Mouse0) || ControlFreak2.CF2Input.GetKeyUp(KeyCode.Mouse1) || ControlFreak2.CF2Input.GetKeyUp(KeyCode.Mouse2) || ControlFreak2.CF2Input.GetMouseButtonUp(0));
                case CameraMouseInputType.LeftAndRight:
                    return (ControlFreak2.CF2Input.GetKeyUp(KeyCode.Mouse0) || ControlFreak2.CF2Input.GetKeyUp(KeyCode.Mouse1));
                case CameraMouseInputType.LeftMouse:
                    return (ControlFreak2.CF2Input.GetKeyUp(KeyCode.Mouse0) || ControlFreak2.CF2Input.GetMouseButtonUp(0));
                case CameraMouseInputType.RightMouse:
                    return (ControlFreak2.CF2Input.GetKeyUp(KeyCode.Mouse1));
                case CameraMouseInputType.MouseScroll:
                    return (ControlFreak2.CF2Input.GetKeyUp(KeyCode.Mouse2));
                case CameraMouseInputType.MobileTouch:
                    return (ControlFreak2.CF2Input.GetMouseButtonUp(0) || ControlFreak2.CF2Input.GetMouseButtonUp(1));
                default:
                    return (ControlFreak2.CF2Input.GetKey(KeyCode.Mouse0) || ControlFreak2.CF2Input.GetMouseButton(0));
            }
        }
    }
